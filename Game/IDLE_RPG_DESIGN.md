...
| `ItemDropRate` | 아이템 드롭률 (%) | 능력치강화 / 문신 |
| `IdleGoldBonus` | 방치 골드 효율 (%) | 능력치강화 / 문신 |
| `IdleExpBonus` | 방치 경험치 효율 (%) | 능력치강화 / 문신 |

> 상세 스탯 설계: [STAT_DESIGN.md](STAT_DESIGN.md)
...
상세 설계 문서: [BATTLE_SYSTEM.md](BATTLE_SYSTEM.md)
